# -*- coding: utf-8 -*-
# ============================================================
# ★ 이 파일을 직접 import 하지 마세요. `pibt_core_v2.py` 를 쓰세요.
#
# 이것은 3_FMS/sim_engine/pibt_core.py 의 **벤더 사본(fallback)** 입니다.
# 상류를 못 찾을 때만 로더가 이걸 씁니다 — 서버에 3_FMS 도 fms/ 도 없는
# 경우가 그것입니다.
#
# 갱신:  python path/sync_pibt_core.py --write
# ============================================================
# ============================================================
